...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">FILIPINO SIGN LANGUAGE <br><b> FLS</b></a>
            <small>FILIPINO SIGN LANGUAGE</small>
        </div>
        <div class="card">
            <div class="body">
    ...
    <script src="{{ asset('Dashboard/js/pages/examples/sign-in.js') }}"></script>
</body>
