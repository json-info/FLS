    ...
    <script src="{{ asset('Dashboard/plugins/jquery-datatable/extensions/export/vfs_fonts.jsv') }}"></script>
    ...
    <script src="{{ asset('Dashboard/plugins/morrisjs/morris.js') }}"></script>

    <!-- ChartJs -->
    <script src="{{ asset('Dashboard/plugins/chartjs/Chart.bundle.js') }}"></script>

    <!-- Flot Charts Plugin Js -->
    <script src="{{ asset('Dashboard/plugins/flot-charts/jquery.flot.js') }}"></script>
    <script src="{{ asset('Dashboard/plugins/flot-charts/jquery.flot.resize.js') }}"></script>
    <script src="{{ asset('Dashboard/plugins/flot-charts/jquery.flot.pie.js') }}"></script>
    <script src="{{ asset('Dashboard/plugins/flot-charts/jquery.flot.categories.js') }}"></script>
    <script src="{{ asset('Dashboard/plugins/flot-charts/jquery.flot.time.js') }}"></script>
